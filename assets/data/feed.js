export default [
  {
    ...
    workExperince:
      'I have been taking wedding phots for ten years, some of my work has been featured in Bride Magazine.',
  ...
  },
  {
    ...
    workExperince:
      'I have been taking wedding phots for three years, I pride myself on taking the time to get the perfect shot.',
  ...
  },
  {
    ...
    workExperince:
      'I have been taking wedding phots for five years, most of my experince is with indoor weddings.',
    venuesWorked:
      'Hotel Havana, Vintage Airstreams Group, Station 3, The Capri',
    coordinate: {
      latitude: 32.5438463,
  ...
  },
  {
    ...
    workExperince:
      'I have been taking wedding phots for two years, most of my experince is with outdoor weddings.',
    venuesWorked:
      'Ma Mansion, Barr Mansion, Blanton Museum of Art, Artspace 1 1 1',
    coordinate: {
      latitude: 32.5218463,
  ...
  },
  {
    ...
    workExperince:
      'I have been taking wedding phots for 15 years, my work speaks for itself.',
    venuesWorked:
      'The White Sparrow Barn, Camp Comfort B & B, Gruene Estates, Hotel Havana, Vintage Airstreams Group, Station 3, The Capri, Ma Mansion, Barr Mansion, Blanton Museum of Art, Artspace 1 1 1, One Eleven East, The Astorian, Pecan Grove',
    coordinate: {
      latitude: 32.753177,
...
//   }){id},
// }
// mutation createPhotographer4 {
//   createPost(input: {image: "/Users/Michael/repos/storia/assets/images/13.jpeg",
//   photographer: "Weegee",
//   description:
//     "Black and White: Black-and-white wedding images are more about editing than photography style, although some photographers do use solely black-and-white cameras.",
//   currentPrice: 175,
...
//     "The White Sparrow Barn, Camp Comfort B & B, Gruene Estates, Hotel Havana, Vintage Airstreams Group, Station 3, The Capri, Ma Mansion, Barr Mansion, Blanton Museum of Art, Artspace 1 1 1, One Eleven East, The Astorian, Pecan Grove",
//   latitude: 32.753177,
//   longitude: -96.9527459,
//   }){id},
// }
// mutation createPhotographer5 {
//   createPost(input: {
//   image: "/Users/Michael/repos/storia/assets/images/14.jpeg",
//   photographer: "Ellen von Unwerth",
//   description:
...
//     "Ma Mansion, Barr Mansion, Blanton Museum of Art, Artspace 1 1 1",
//   latitude: 33.9218463,
//   longitude: -95.17283827,
//   }){id},
// }

// query showAllPhotographers {
//   listPhotographer{
//     items {
//       id
//       photographer
...
// query showAllPhotographersBasedOnLocation {
//   listPosts(filter: {
//     and: {
//       latitude: {
//         between:[
//           32.7254100, 32.7791670],# DFW boundries

//       }
//       longitude: {
//         between: [
//           -97.3208500, -96.8088910
//         ],# DFW boundries
//       }
//     }
//   }) {
